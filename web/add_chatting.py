...
# Chatting 레코드 추가
chattings = [
    {"chatting_id": "ch_00001", "profile": CustomUser.objects.get(username="user1"), "content": '''
        <나>안녕하세요?
        <봇>안녕하세요!
    '''},
    ...
    {"chatting_id": "ch_00004", "profile": CustomUser.objects.get(username="user1"), "content": ''' 
        <나>1
        <봇>2
        <나>3
        <봇>4
        ...
        <봇>22
    '''},
    {"chatting_id": "ch_00005", "profile": CustomUser.objects.get(username="user1"), "content": '''
        <나>감사합니다!
        <봇>감사합니다!
        <나>감사합니다?
        <봇>감사합니다?
    '''},
    {"chatting_id": "ch_00006", "profile": CustomUser.objects.get(username="user1"), "content": '''
        <나>장난하냐?
        <봇>죄송합니다...
    '''},
]
