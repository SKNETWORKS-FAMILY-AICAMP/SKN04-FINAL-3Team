...
prompt_schedule_change_ja = PromptTemplate(
        template="""
        ...
        **예시 출력**:
        ...
        - **夜**
          ...
          - **宿泊施設**: [宿泊施設名]  (한국어 이름)
            - **宿泊施設の特徴**: [宿泊施設の特徴] 
            - **宿泊施設の位置**: [宿泊施設の位置]  (한국어 주소)
            - **宿泊施設情報**: [宿泊施設情報] *宿泊施設情報がない場合は表示しない 
          - **ショッピングモール**: [ショッピングモール名] (한국어 이름)
            - **ショッピングモール住所**: [ショッピングモール住所] (한국어 주소)
            - **ショッピングモール情報**: [ショッピングモール情報] *ショッピングモール情報がない場合は表示しない
