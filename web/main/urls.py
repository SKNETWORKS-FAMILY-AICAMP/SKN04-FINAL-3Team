...
urlpatterns = [
    ...
    path('app/partials/favorites/get_bookmark_place/', views.get_bookmark_place, name='get_bookmark_place'),
    path('app/partials/favorites/get_bookmark_schedule/', views.get_bookmark_schedule, name='get_bookmark_schedule'),
